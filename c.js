...
function EnsureIsPopulated(){
  ...
  if(!id("Canvas").innerHTML && !!id("RawJson").value) doFormatJson();
...
function FullScreenClicked(){
	var vds=id("Canvas");
	if(vds.requestFullscreen)
	{
		vds.requestFullscreen();
	}else if(vds.mozRequestFullScreen)
	{
		vds.mozRequestFullScreen();
	}else if(vds.webkitRequestFullScreen)
	{
		vds.webkitRequestFullScreen();
	}else
	{
		console.log("不支持全屏");
	}	
